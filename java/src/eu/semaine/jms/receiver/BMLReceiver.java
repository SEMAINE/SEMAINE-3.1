...
public class BMLReceiver extends XMLReceiver
{
	/**
	 ...
	 */
	public BMLReceiver(String topicName) throws JMSException
	{
		super(topicName);
	}
	 ...
	 */
	public BMLReceiver(String topicName, String messageSelector)
	throws JMSException
	{
	 ...
	 * @param topic the name of the JMS Topic to listen to.
	 */
	public BMLReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName) throws JMSException
	{
	 ...
	 * for the detailed description.
	 */
	public BMLReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName, String messageSelector)
	throws JMSException
	{
