...
public class XMLReceiver extends Receiver
{
	 ...
	 * @param topic the name of the JMS Topic to listen to.
	 */
	public XMLReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName) throws JMSException
	{
	 ...
	 * for the detailed description.
	 */
	public XMLReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName, String messageSelector)
	throws JMSException
	{
