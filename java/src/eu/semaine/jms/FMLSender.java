...
public class FMLSender extends XMLSender
{
	 ...
	 */
	public FMLSender(String topicName, String datatype, String source)
	throws JMSException
	{
	 ...
	 */
	public FMLSender(String jmsUrl, String jmsUser, String jmsPassword, String topicName, String datatype, String source)
	throws JMSException
	{
