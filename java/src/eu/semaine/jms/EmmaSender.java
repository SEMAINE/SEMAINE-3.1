 ...
 *
 */
public class EmmaSender extends XMLSender
{
	/**
	 ...
	 */
	public EmmaSender(String topicName, String source)
	throws JMSException
	{
		super(topicName, "EMMA", source);
	}
	 ...
	 */
	public EmmaSender(String jmsUrl, String jmsUser, String jmsPassword, String topicName, String source)
	throws JMSException
	{
		super(jmsUrl, jmsUser, jmsPassword, topicName, "EMMA", source);
	}
