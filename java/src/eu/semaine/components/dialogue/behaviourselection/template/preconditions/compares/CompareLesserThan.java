...
/**
 * A CompareLesserThan checks if the first value is smaller than the second value.
 * Only compares Integers and Doubles, and returns true if the first value is smaller than the second value, 
...
public class CompareLesserThan extends Compare
{
	/**
	 * Creates a new CompareLesserThan with the given values.
	 * 
	 * @param value1
	 * @param value2
	 * @throws TemplateParseException
	 */
	public CompareLesserThan( String value1, String value2 ) throws TemplateParseException
	{
		super(value1, value2, Compare.Comparator.lesser_than);
	}
	
	/**
	 * Given the current InformationState, checks if the the first value is smaller than the second value.
	 * 
	 * @param is - the current InformationState
	 * @returns	true  - if the first value is smaller than the second value
	 * 			false - if the first value is greater or equal to to the second, or of incomparable types 
	 */
