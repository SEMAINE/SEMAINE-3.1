...
/**
 * A CompareLesserEquals checks if the first value is smaller or equals to the second value.
 * Only compares Integers and Doubles, and returns true if the first value is smaller or equal to the second value, 
...
public class CompareLesserEquals extends Compare
{
	/**
	 * Creates a new CompareLesserEquals with the given values.
	 * 
	 * @param value1
	 * @param value2
	 * @throws TemplateParseException
	 */
	public CompareLesserEquals( String value1, String value2 ) throws TemplateParseException
	{
		super(value1, value2, Compare.Comparator.lesser_equals);
	}
	
	/**
	 * Given the current InformationState, checks if the the first value is smaller or equal to the second value.
	 * 
	 * @param is - the current InformationState
	 * @returns	true  - if the first value is smaller or equal to the second value
	 * 			false - if the first value is greater than to the second, or of incomparable types 
	 */
