...
public class DummyBMLRealiserAndPlayer extends Component 
{
	...
	public void react(SEMAINEMessage m) throws JMSException
	{
		...
		Element head = XMLTool.getChildElementByLocalNameNS(bml, BML.E_HEAD, BML.namespaceURI);
		if (head != null) {
		...
		Element face = XMLTool.getChildElementByLocalNameNS(bml, BML.E_FACE, BML.namespaceURI);
		if (face != null) {
