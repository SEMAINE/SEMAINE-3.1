...
#ifndef SEMAINE_CMS_SENDER_FMLSENDER_H
#define SEMAINE_CMS_SENDER_FMLSENDER_H
...
class FMLSender : public XMLSender
{
public:
	/**
	 ...
	 * @throws CMSException
	 */
	FMLSender(const std::string & topicName, const std::string & source)
	throw(CMSException, SystemConfigurationException) :
		XMLSender(topicName, "FML", source)
	{
	}
	 ...
	 * @throws CMSException
	 */
	FMLSender(const std::string & cmsUrl, const std::string & cmsUser, const std::string & cmsPassword, const std::string & topicName, const std::string & source)
	throw (CMSException, SystemConfigurationException) :
		XMLSender(cmsUrl, cmsUser, cmsPassword, topicName, "FML", source)
	{
	}
