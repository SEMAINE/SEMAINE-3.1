 ...
 *
 * @@ This file was modified by Martin Woellmer from TUM Germany, July 2009,
 *    to fix a bug in parameter output when using -userlm option @@
 *
 * $Revision: 1.9 $
 * 
 */
...
//does not work for user defined LM!
