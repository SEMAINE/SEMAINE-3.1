...
#ifndef SEMAINE_COMPONENTS_SMILE_TUMKEYWORDSPOTTER_H
#define SEMAINE_COMPONENTS_SMILE_TUMKEYWORDSPOTTER_H
...
#undef class
class TumKeywordSpotter : public ComponentForSmile
{
public:
	TumKeywordSpotter(cComponentManager *_cMan, cConfigManager *_conf) throw (CMSException);
 
	virtual ~TumKeywordSpotter();
...
#endif // SEMAINE_COMPONENTS_SMILE_TUMKEYWORDSPOTTER_H
