...
#ifndef __CPORTAUDIODUPLEXS_HPP
#define __CPORTAUDIODUPLEXS_HPP
...
#define COMPONENT_DESCRIPTION_CPORTAUDIODUPLEXS "dataProcessor for full-duplex playback and recording of live audio using PortAudio library"
#define COMPONENT_NAME_CPORTAUDIODUPLEXS "cPortaudioDuplexS"
...
#undef class
class DLLEXPORT cPortaudioDuplexS : public cDataProcessor {
  private:
    PaStream *stream;
    float *paBuffer;
    long paFrames;
  ...
  public:
    ...
    cPortaudioDuplexS(const char *_name);
