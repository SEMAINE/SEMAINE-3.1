...
#ifndef SEMAINE_COMPONENTS_SMILE_TUMNONVERBALSENDER_H
#define SEMAINE_COMPONENTS_SMILE_TUMNONVERBALSENDER_H
...
#undef class
class TumNonverbalFeatureExtractor : public ComponentForSmile
{
public:
	TumNonverbalFeatureExtractor(cComponentManager *_cMan, cConfigManager *_conf) throw (CMSException);
 
	virtual ~TumNonverbalFeatureExtractor();
...
#endif // SEMAINE_COMPONENTS_SMILE_TUMNONVERBALSENDER_H
