...
#ifndef SEMAINE_COMPONENTS_SMILE_TUMEMOTIONANALYSER_H
#define SEMAINE_COMPONENTS_SMILE_TUMEMOTIONANALYSER_H
...
#undef class
class TumEmotionAnalyser : public ComponentForSmile
{
public:
	TumEmotionAnalyser(cComponentManager *_cMan, cConfigManager *_conf) throw (CMSException);
 
	virtual ~TumEmotionAnalyser();
...
#endif // SEMAINE_COMPONENTS_SMILE_TUMEMOTIONANALYSER_H
