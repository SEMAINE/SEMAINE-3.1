...
SMILECOMPONENT_REGCOMP(cFunctionalPercentiles)
{
  ...
  SMILECOMPONENT_IFNOTREGAGAIN(
    ct->setField("quartiles","1/0=enable/disable output of all quartiles (overrides individual settings quartile1, quartile2, and quartile3)",1);
    ...
    ct->setField("iqr","1/0=enable/disable output of all inter-quartile ranges (overrides individual settings iqr12, iqr23, and iqr13)",1);
