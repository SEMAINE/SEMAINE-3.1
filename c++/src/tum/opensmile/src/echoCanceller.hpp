...
#ifndef __CECHOCANCELLER_HPP
#define __CECHOCANCELLER_HPP
...
#define COMPONENT_DESCRIPTION_CECHOCANCELLER "adaptive echo cancellation using Speex Codec library"
#define COMPONENT_NAME_CECHOCANCELLER "cEchoCanceller"

#undef class
class DLLEXPORT cEchoCanceller : public cDataProcessor {
  private:
...
*/
  ...
  public:
    ...
    cEchoCanceller(const char *_name);
