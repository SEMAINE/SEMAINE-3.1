...
/** START EXIT REDEFINITION; ADDED BY BJOERN 2004-04-21 ***/
#if     _MSC_VER >= 1200
_CRTIMP __declspec(noreturn) void   __cdecl exit(int);
#else
_CRTIMP void   __cdecl exit(int);
#endif
/***** END EXIT REDEFINITION HACK *************************/
# endif
#else
/* non-Win32 case. */
...
/***********************************************************************/
/* Add new glutCheckLoop entity ... Rob Fletcher R.Fletcher@york.ac.uk */
/* April 2002                                                          */
...
/***********************************************************************/
/* New WM Close call back  added by Rob Fletcher R.Fletcher@york.ac.uk */
/* April 2002                                                          */
GLUTAPI void APIENTRY glutWMCloseFunc(void (GLUTCALLBACK *func)(void));
/***********************************************************************/
