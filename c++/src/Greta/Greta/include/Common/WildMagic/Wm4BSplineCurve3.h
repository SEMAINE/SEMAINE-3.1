...
#ifndef WM4BSPLINECURVE3_H
#define WM4BSPLINECURVE3_H
...
template <class Real>
class WM4_FOUNDATION_ITEM BSplineCurve3 : public SingleCurve3<Real>
{
public:
    ...
    BSplineCurve3 (int iNumCtrlPoints, const Vector3<Real>* akCtrlPoint,
