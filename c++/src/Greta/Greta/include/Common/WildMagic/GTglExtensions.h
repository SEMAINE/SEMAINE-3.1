...
#ifndef GTGLEXTENSIONS_H
#define GTGLEXTENSIONS_H

#if defined(__gl_h_) || defined(__GL_H__)
#error gl.h included before GTglExtensions.h
#endif
#if defined(__glext_h_) || defined(__GLEXT_H_)
#error glext.h included before GTglExtensions.h
#endif
#if defined(__gl_ATI_h_)
#error glATI.h included before GTglExtensions.h
#endif
#define __gl_h_
#define __GL_H__
#define __glext_h_
