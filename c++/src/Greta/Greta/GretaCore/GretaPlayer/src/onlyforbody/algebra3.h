...
//	PI
//
const double M_PIGRECO = 3.14159265358979323846;		// per CRC handbook, 14th. ed.
const double M_PI_2 = (3.14159265358979323846/2.0);				// PI/2
const double M2_PI = (3.14159265358979323846*2.0);				// PI*2
...
inline mat3 rotation2D(const vec2& Center, const double angleDeg) {
    double  angleRad = angleDeg * M_PIGRECO / 180.0,
	    c = cos(angleRad),
	    s = sin(angleRad);
