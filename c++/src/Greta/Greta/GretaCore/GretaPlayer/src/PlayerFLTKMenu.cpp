...
// PlayerFLTKMenu.cpp: implementation of the PlayerFLTKMenu class.
//
//////////////////////////////////////////////////////////////////////
...
PlayerFLTKMenu::PlayerFLTKMenu(int x,int y,int w,int h):Fl_Menu_Bar(x,y,w,h,"")
{
	/*
	Fl_Menu_Item popup[] = {
	{"&alpha", 0, 0, 0, 0},
...
PlayerFLTKMenu::~PlayerFLTKMenu()
{

}


//DEL int PlayerFLTKMenu::handle(int event)
//DEL {
//DEL  
