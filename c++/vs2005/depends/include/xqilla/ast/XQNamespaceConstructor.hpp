 ...
 *
 * $Id: XQNamespaceConstructor.hpp 531 2008-04-10 23:23:07Z jpcs $
 */

#ifndef XQNAMESPACECONSTRUCTOR_HPP
#define XQNAMESPACECONSTRUCTOR_HPP

#include <xqilla/ast/XQDOMConstructor.hpp>

class XQILLA_API XQNamespaceConstructor : public XQDOMConstructor
{
public:
  XQNamespaceConstructor(ASTNode* name, VectorOfASTNodes* children, XPath2MemoryManager* mm);
