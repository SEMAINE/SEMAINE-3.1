 ...
 *
 * $Id: UInsertAfter.hpp 659 2008-10-06 00:11:22Z jpcs $
 */

#ifndef _UINSERTAFTER_HPP
#define _UINSERTAFTER_HPP

#include <xqilla/framework/XQillaExport.hpp>
#include <xqilla/ast/ASTNodeImpl.hpp>

class XQILLA_API UInsertAfter : public ASTNodeImpl
{
public:
  UInsertAfter(ASTNode *source, ASTNode *target, XPath2MemoryManager* memMgr);
