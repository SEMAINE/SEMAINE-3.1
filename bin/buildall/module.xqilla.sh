...
XQILLA_BASE="XQilla-2.2.4"

#XQILLA_URL="http://downloads.sourceforge.net/project/xqilla/xqilla/2.2.4/$XQILLA_BASE.tar.gz"
XQILLA_URL="http://puzzle.dl.sourceforge.net/project/xqilla/xqilla/2.2.4/$XQILLA_BASE.tar.gz"
