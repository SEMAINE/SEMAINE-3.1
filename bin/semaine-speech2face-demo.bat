...
if %1%a==a (
  set CONFIG="%BINDIR%..\java\config\speech2face-demo.config"
) else (
  set CONFIG=%1%
)
...
java -Xmx1500m -Dlog4j.logger.semaine=DEBUG,logfile,stderr %JMS_URL_SETTING% -classpath %JARDIR%\semaine.jar;%JARDIR%\semaine-mary.jar;%JARDIR%\semaine-dialogue.jar -Dmary.base=%MARYDIR% eu.semaine.system.ComponentRunner %CONFIG%
